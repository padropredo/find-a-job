...
const JobOfferCard = ({ jobOffer,fetch,profileId }) => {
  ...
  return (
    <div>
      ...
      <ViewOfferModal show={showAllInfoModal} handleClose={handleCloseModal} jobOffer={jobOffer} fetch={fetch} profileId={profileId}/>
    </div>
